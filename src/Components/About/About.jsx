                ...
                <div id="data" className="about-me container">
                    ...
                    <div className="row">
                        <div className="col-lg-4" data-aos="fade-right">
                            <img src="assets/img/deepak3.jpg" className="img-fluid" alt="" />
                        </div>
                        <div className="col-lg-8 pt-4 pt-lg-0 content" data-aos="fade-left">
                            <h3>MERN Stack || Frontend Developer at Byte Billion ,Indore(M.P.)  || React || Photoshop</h3>
                            <p className="fst-italic">
                                I am  MERN-stack web developer and javascript specialist.
                            ...
                            <div className="row">
                                <div className="col-lg-6">
                                    <ul className='fst-italic'>
                                        <li><i className="bi bi-chevron-right"></i> <strong>Birthday:</strong> <span>18 July 2002</span></li>
                                        {/* <li><i className="bi bi-chevron-right"></i> <strong>Website:</strong> <span>www.example.com</span></li> */}
                                        <li><i className="bi bi-chevron-right"></i> <strong>Phone:</strong> <span>+91-9993613221</span></li>
                                ...
                                <div className="col-lg-6">
                                    <ul className='fst-italic'>
                                        ...
                                        <li><i className="bi bi-chevron-right"></i> <strong>Degree:</strong> <span>MCA(3rd sem)</span></li>
                                        <li><i className="bi bi-chevron-right"></i> <strong>Email:</strong> <span>deepakrathor3221@gmail.com</span></li>
