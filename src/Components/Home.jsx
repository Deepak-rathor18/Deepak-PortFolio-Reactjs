...
export const Home = () => {
    ...
    <div className="container">
      ...
      <h1><a href="index.html">𝓓𝓮𝓮𝓹𝓪𝓴 𝓡𝓪𝓽𝓱𝓸𝓻</a></h1>
      {/* <!-- Uncomment below if you prefer to use an image logo -->
      <!-- <a href="index.html" className="mr-auto"><img src="assets/img/logo.png" alt="" className="img-fluid"></a> --> */}
      <h2>I'm a passionate <span> MERN-STACK-DEVELOPER </span> from Indore (M.P) India</h2>

      <nav id="navbar" className="navbar ">
        <ul>
        <li onClick={targetNavForCenter}><Link className="nav-link active radious" to="/Home">Home</Link></li>
          <li onClick={targetNavForTop}><Link className="nav-link radious"  to="/About">About</Link></li>
          <li onClick={targetNavForTop}><Link className="nav-link radious"  to="/Resume">Resume</Link></li>
          <li onClick={targetNavForTop}><Link className="nav-link radious"  to="/Services">My Projects</Link></li>
          <li onClick={targetNavForTop}><Link className="nav-link radious"  to="/Contact">Contact</Link></li>
      ...
      <div className="social-links">
        <a href="https://github.com/Deepak-rathor18"  className="twitter"><i className="fab fa-github"></i></a>
        <a href="https://www.facebook.com/profile.php?id=100053611511434&mibextid=ZbWKwL" className="facebook"><i className="bi bi-facebook"></i></a>
        <a href="https://instagram.com/mr_deepak__rathor?igshid=ZDdkNTZiNTM=" className="instagram"><i className="bi bi-instagram"></i></a>
